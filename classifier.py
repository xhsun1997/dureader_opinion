...
def evaluate_classify(exe,
    ...
    if metric == 'acc_and_f1':
        ...
        evaluate_info = "[%s evaluation] ave loss: %f, pearson:%f, spearman:%f, corr:%f, data_num: %d, elapsed \
            time: %f s" % (eval_phase, cost, ret['pearson'], ret['spearman'], ret['corr'], total_num_seqs, elapsed_time)
